...
async function reviewMessage(messageText) {
  ...
  const prompt = `
    Check to see if the message overall has a positive or neutral tone. If it has a negative tone, provide a score for each of the following categories on a scale of 1-10 (1 being the worst, 10 being the best). If the message is positive or neutral, do not provide any scores or give any feedback.
